...
3. **Declaración de Reparto (CRÍTICO):** Verifica si el usuario pidió incluir personajes/props que existen en la carpeta `characters/` del cliente. Si es así, DEBES escribir al inicio del archivo la línea: `**Reparto (Lore):** [[ID_Tag1], [ID_Tag2]]`. Si no hay ninguno, escribe `**Reparto (Lore):** none`.
