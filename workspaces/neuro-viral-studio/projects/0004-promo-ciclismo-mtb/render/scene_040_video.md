...
CAMERA / TIMING: Cinematic drone pull-back. The camera starts on the cyclist's face and smoothly flies backward, revealing the long dirt trail traversing the beautiful mountain landscape from left to right.
CRITICAL: The character must NOT speak under any circumstance. Silent action only. He smiles naturally at the camera but his mouth remains completely closed. No open mouth breathing.
